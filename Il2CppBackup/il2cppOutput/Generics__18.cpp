...
IL_0009:
	...
	try
	{
		...
		try
		{
			TerrainTileCoord_t2181DDF40A8A428A84817957CB7FB19A314F4F09 L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_Add_mCDB94B777C71A4AEC648AEE14D9C777B05667901(__this, L_3, ((RuntimeObject*)Castclass((RuntimeObject*)L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15))), il2cpp_rgctx_method(method->klass->rgctx_data, 20));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_m7E276047DB29276D2CA2537EFFDD97FB7206B5A6(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 43));
		int32_t L_12 = V_1;
		return L_12;
	}
}
