...
IL_002b:
	...
	}
	{
		...
		NullCheck(L_8);
		bool L_10;
		L_10 = Func_2_Invoke_m9FA39B8DEA77C935CA4CD6350B1D5CF2352B9934_inline(L_8, L_9, il2cpp_rgctx_method(method->klass->rgctx_data, 12));
		if (!L_10)
		{
			goto IL_0061;
		}
...
IL_004d:
	{
		...
		L_13 = Func_2_Invoke_m2B252F366CA1BBF8CEDB0E94EE60FFDB427B9EC1_inline(L_11, L_12, il2cpp_rgctx_method(method->klass->rgctx_data, 13));
...
IL_0061:
	{
		...
		bool L_15;
		L_15 = Enumerator_MoveNext_mBCE3BB01361CEE4EF8AD330608F6D15C8DC2A92B(L_14, il2cpp_rgctx_method(method->klass->rgctx_data, 15));
		if (L_15)
		{
			goto IL_002b;
		}
...
IL_004d:
	{
		...
		NullCheck(L_11);
		uint16_t L_13;
		L_13 = Func_2_Invoke_m2ECC14FE002EE4F1566BABB2A2456DE189E928BC_inline(L_11, L_12, il2cpp_rgctx_method(method->klass->rgctx_data, 13));
...
IL_004d:
	{
		...
		NullCheck(L_11);
		uint16_t L_13;
		L_13 = Func_2_Invoke_m6C27630AC0CBF93DAA426F15A0B38A19ABF3AB3A_inline(L_11, L_12, il2cpp_rgctx_method(method->klass->rgctx_data, 13));
		((Iterator_1_t369CEF6AB0EA6E5A52B70B55796F94C272F0384E*)__this)->___current = L_13;
		return (bool)1;
	}
