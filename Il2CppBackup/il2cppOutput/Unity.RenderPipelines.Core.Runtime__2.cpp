...
IL_0084:
	{
		...
		((L_11)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_12)))->___r = L_14;
		int32_t L_15 = V_1;
...
IL_0059:
	{
		...
		NullCheck(L_8);
		int32_t L_10 = L_9;
		ValueTuple_2_tBF1FF91C6AA1C2F4EA2868A6BB50A581AC4E5141 L_11 = (L_8)->GetAt(static_cast<il2cpp_array_size_t>(L_10));
...
IL_0086:
	{
		...
		NullCheck(L_30);
		VirtualActionInvoker1< int32_t >::Invoke(13, L_30, L_34);
...
IL_00b4:
	{
		...
		NullCheck(L_39);
		VirtualActionInvoker1< int32_t >::Invoke(13, L_39, L_43);
...
IL_002d:
	{
		...
		float L_10 = V_0;
		NullCheck(L_9);
		VirtualActionInvoker1< float >::Invoke(13, L_9, L_10);
		DebugUIHandlerFloatField_UpdateValueLabel_m82D62BFA0C18D2A4B2B1A6869F059FD2B7E836B1(__this, NULL);
		return;
	}
}
