...
{
	Exception_t* ___fillTextureException = il2cpp_codegen_get_marshal_directive_exception("Cannot marshal field 'fillTexture' of type 'SpriteShapeParameters': Reference type field marshaling is not supported.");
