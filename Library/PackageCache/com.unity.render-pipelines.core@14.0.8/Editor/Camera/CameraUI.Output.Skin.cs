    ...
    public static partial class CameraUI
    {
        ...
        public static partial class Output
        {
            ...
            public static class Styles
            {
                ...
                public static readonly GUIContent enableGDRP = EditorGUIUtility.TrTextContent("EnableGDRP", "Enable the excellent 'GPU Driven Render Pipeline'.");
                public static readonly GUIContent backfaceCulling = EditorGUIUtility.TrTextContent("Backface Culling", "Enable backface culling.");
