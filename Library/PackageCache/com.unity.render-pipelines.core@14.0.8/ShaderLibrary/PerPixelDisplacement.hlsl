    ...
    UNITY_GDRP_MATERIAL_PAGE_OFFSET_PARAMETER)
{
    ...
    real prevHeight = ComputePerPixelHeightDisplacement(texOffsetCurrent, lod, ppdParam POM_USER_DATA_ARGUMENTS UNITY_GDRP_MATERIAL_PAGE_OFFSET_ARGUMENT);
    texOffsetCurrent += texOffsetPerStep;
    real currHeight = ComputePerPixelHeightDisplacement(texOffsetCurrent, lod, ppdParam POM_USER_DATA_ARGUMENTS UNITY_GDRP_MATERIAL_PAGE_OFFSET_ARGUMENT);
