...
namespace UnityEditor.ShaderGraph.Internal
{
    ...
    public struct ShaderGraphRequirements
    {
        ...
        [SerializeField] bool m_RequiresVG;
        ...
        public bool requiresVG
        {
            get { return m_RequiresVG; }
            internal set { m_RequiresVG = value; }
        }
        ...
        internal ShaderGraphRequirements Union(ShaderGraphRequirements other)
        {
            ...
            newReqs.m_RequiresVG = other.m_RequiresVG | m_RequiresVG;
            ...
            where T : AbstractMaterialNode
        {
            ...
            // In fragment stage, if there's any node about VG, we should add VG's variables.
            // Besides, we need to iterate all nodes to make sure that nodes' stageCapability
            // is set correctly to create codes corresponding to VG's need by RequiresVG. So
            // we should use Aggregate instead of Any here.
            bool requiresVG = nodes.OfType<IMayRequireVG>().Aggregate(false, (mask, node) => mask | node.RequiresVG(stageCapability));
