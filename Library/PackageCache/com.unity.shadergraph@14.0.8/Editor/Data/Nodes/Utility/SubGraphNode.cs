...
namespace UnityEditor.ShaderGraph
{
        ...
        , IMayRequireVG
    {
        ...
        public void GenerateNodeCode(ShaderStringBuilder sb, GenerationMode generationMode)
        {
            ...
            GenerationUtils.GenerateSurfaceInputTransferCode(sb, asset.requirements, asset.inputStructName, inputVariableName, m_StageCapability);
            ...
            // For GBufferSplat, we should pass the variable, named materialOffset, to SubGraph.
            arguments.Add("materialOffset");
        ...
        public bool RequiresVG(ShaderStageCapability stageCapability)
        {
            ...
            // SubGraphNode include one or more nodes, so the ShaderStageCapability,
            // supported by SubGraphNode, is determined by nodes which it includes.
            // This will influence our VG in requirements.
            if (asset == null)
                return false;
            return asset.requirements.requiresVG;
        }
