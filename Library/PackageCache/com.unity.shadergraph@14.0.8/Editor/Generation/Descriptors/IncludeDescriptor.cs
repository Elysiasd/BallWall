...
namespace UnityEditor.ShaderGraph
{
    ...
    {
        public IncludeDescriptor(string guid, string path, IncludeLocation location, FieldCondition[] fieldConditions, bool shouldIncludeWithPragmas = false, bool builtinInclude = false)
        {
            _guid = guid;
            _path = path;
            _location = location;
            ...
            _builtinInclude = builtinInclude;
        }
        ...
        [SerializeField]
        bool _builtinInclude;
        public bool builtinInclude => _builtinInclude;
